...
import EUCJPSMModel              from './statemachine/EUCJPSMModel';
import EUCJPDistributionAnalysis from './distributionanalysis/EUCJPDistributionAnalysis';
import EUCJPContextAnalysis      from './contextanalysis/EUCJPContextAnalysis';
...
class EUCJPProber extends CharsetProber {
  ...
  private contextAnalyzer:EUCJPContextAnalysis;
  private distributionAnalyzer:EUCJPDistributionAnalysis;
  ...
  public constructor() {
    super();
    this.codingSM = new CodingStateMachine(EUCJPProber.smModel);
  ...
  public getConfidence():number {
    let contextCf:number = this.contextAnalyzer.getConfidence(); // float
    let distribCf:number = this.distributionAnalyzer.getConfidence(); // float
