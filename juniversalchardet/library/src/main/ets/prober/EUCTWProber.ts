...
import EUCTWSMModel              from './statemachine/EUCTWSMModel';
import EUCTWDistributionAnalysis from './distributionanalysis/EUCTWDistributionAnalysis';
...
class EUCTWProber extends CharsetProber {
  ...
  private distributionAnalyzer:EUCTWDistributionAnalysis;
  ...
  public constructor() {
    super();
    this.codingSM = new CodingStateMachine(EUCTWProber.smModel);
