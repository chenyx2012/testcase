...
class ISO2022KRSMModel extends SMModel {
  ////////////////////////////////////////////////////////////////
  // constants
  ////////////////////////////////////////////////////////////////
  public static ISO2022KR_CLASS_FACTOR:number = 6;

  ////////////////////////////////////////////////////////////////
  // methods
  ////////////////////////////////////////////////////////////////
  public constructor() {
    super(new PkgInt(PkgInt.INDEX_SHIFT_4BITS, PkgInt.SHIFT_MASK_4BITS, PkgInt.BIT_SHIFT_4BITS, PkgInt.UNIT_MASK_4BITS, ISO2022KRSMModel.iso2022krClassTable),
          ISO2022KRSMModel.ISO2022KR_CLASS_FACTOR,
          new PkgInt(PkgInt.INDEX_SHIFT_4BITS, PkgInt.SHIFT_MASK_4BITS, PkgInt.BIT_SHIFT_4BITS, PkgInt.UNIT_MASK_4BITS, ISO2022KRSMModel.iso2022krStateTable),
          ISO2022KRSMModel.iso2022krCharLenTable,
  ...
  // constants continued
  ////////////////////////////////////////////////////////////////
  private static iso2022krClassTable:number[] = [
  ...
  private static iso2022krStateTable:number[] = [
    PkgInt.pack4bits(SMModel.START, 3, SMModel.ERROR, SMModel.START, SMModel.START, SMModel.START, SMModel.ERROR, SMModel.ERROR),//00-07
    ...
    PkgInt.pack4bits(SMModel.ITSME, SMModel.ITSME, SMModel.ERROR, SMModel.ERROR, SMModel.ERROR, 4, SMModel.ERROR, SMModel.ERROR),//10-17
    PkgInt.pack4bits(SMModel.ERROR, SMModel.ERROR, SMModel.ERROR, SMModel.ERROR, 5, SMModel.ERROR, SMModel.ERROR, SMModel.ERROR),//18-1f
    PkgInt.pack4bits(SMModel.ERROR, SMModel.ERROR, SMModel.ERROR, SMModel.ITSME, SMModel.START, SMModel.START, SMModel.START, SMModel.START) //20-27
  ];

  private static iso2022krCharLenTable:number[] = [
    0, 0, 0, 0, 0, 0
  ];
}

export default ISO2022KRSMModel;