...
class EUCTWSMModel extends SMModel {
  ////////////////////////////////////////////////////////////////
  // constants
  ////////////////////////////////////////////////////////////////
  public static EUCTW_CLASS_FACTOR:number = 7;

  ////////////////////////////////////////////////////////////////
  // methods
  ////////////////////////////////////////////////////////////////
  public constructor() {
    super(new PkgInt(PkgInt.INDEX_SHIFT_4BITS, PkgInt.SHIFT_MASK_4BITS, PkgInt.BIT_SHIFT_4BITS, PkgInt.UNIT_MASK_4BITS, EUCTWSMModel.euctwClassTable),
          EUCTWSMModel.EUCTW_CLASS_FACTOR,
          new PkgInt(PkgInt.INDEX_SHIFT_4BITS, PkgInt.SHIFT_MASK_4BITS, PkgInt.BIT_SHIFT_4BITS, PkgInt.UNIT_MASK_4BITS, EUCTWSMModel.euctwStateTable),
          EUCTWSMModel.euctwCharLenTable,
  ...
  // constants continued
  ////////////////////////////////////////////////////////////////
  private static euctwClassTable:number[] = [
  ...
  private static euctwStateTable:number[] = [
    PkgInt.pack4bits(SMModel.ERROR, SMModel.ERROR, SMModel.START, 3, 3, 3, 4, SMModel.ERROR),//00-07
    ...
    PkgInt.pack4bits(SMModel.ITSME, SMModel.ITSME, SMModel.ITSME, SMModel.ITSME, SMModel.ITSME, SMModel.ERROR, SMModel.START, SMModel.ERROR),//10-17
    PkgInt.pack4bits(SMModel.START, SMModel.START, SMModel.START, SMModel.ERROR, SMModel.ERROR, SMModel.ERROR, SMModel.ERROR, SMModel.ERROR),//18-1f
    PkgInt.pack4bits(5, SMModel.ERROR, SMModel.ERROR, SMModel.ERROR, SMModel.START, SMModel.ERROR, SMModel.START, SMModel.START),//20-27
    PkgInt.pack4bits(SMModel.START, SMModel.ERROR, SMModel.START, SMModel.START, SMModel.START, SMModel.START, SMModel.START, SMModel.START) //28-2f
  ];

  private static euctwCharLenTable:number[] = [
    0, 0, 1, 2, 2, 2, 3
  ];
}

export default EUCTWSMModel;