...
class EUCJPSMModel extends SMModel {
  ...
  ////////////////////////////////////////////////////////////////
  public constructor() {
    super(new PkgInt(PkgInt.INDEX_SHIFT_4BITS, PkgInt.SHIFT_MASK_4BITS, PkgInt.BIT_SHIFT_4BITS, PkgInt.UNIT_MASK_4BITS, EUCJPSMModel.eucjpClassTable),
          EUCJPSMModel.EUCJP_CLASS_FACTOR,
          new PkgInt(PkgInt.INDEX_SHIFT_4BITS, PkgInt.SHIFT_MASK_4BITS, PkgInt.BIT_SHIFT_4BITS, PkgInt.UNIT_MASK_4BITS, EUCJPSMModel.eucjpStateTable),
          EUCJPSMModel.eucjpCharLenTable,
  ...
  private static eucjpStateTable:number[] = [
    PkgInt.pack4bits(3, 4, 3, 5, SMModel.START, SMModel.ERROR, SMModel.ERROR, SMModel.ERROR),//00-07
    ...
    PkgInt.pack4bits(SMModel.ITSME, SMModel.ITSME, SMModel.START, SMModel.ERROR, SMModel.START, SMModel.ERROR, SMModel.ERROR, SMModel.ERROR),//10-17
    PkgInt.pack4bits(SMModel.ERROR, SMModel.ERROR, SMModel.START, SMModel.ERROR, SMModel.ERROR, SMModel.ERROR, 3, SMModel.ERROR),//18-1f
