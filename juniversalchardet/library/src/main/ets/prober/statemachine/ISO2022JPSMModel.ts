...
class ISO2022JPSMModel extends SMModel {
  ...
  ////////////////////////////////////////////////////////////////
  public constructor() {
    super(new PkgInt(PkgInt.INDEX_SHIFT_4BITS, PkgInt.SHIFT_MASK_4BITS, PkgInt.BIT_SHIFT_4BITS, PkgInt.UNIT_MASK_4BITS, ISO2022JPSMModel.iso2022jpClassTable),
          ISO2022JPSMModel.ISO2022JP_CLASS_FACTOR,
          new PkgInt(PkgInt.INDEX_SHIFT_4BITS, PkgInt.SHIFT_MASK_4BITS, PkgInt.BIT_SHIFT_4BITS, PkgInt.UNIT_MASK_4BITS, ISO2022JPSMModel.iso2022jpStateTable),
          ISO2022JPSMModel.iso2022jpCharLenTable,
  ...
  private static iso2022jpStateTable:number[] = [
    ...
    PkgInt.pack4bits(SMModel.START, SMModel.START, SMModel.ERROR, SMModel.ERROR, SMModel.ERROR, SMModel.ERROR, SMModel.ERROR, SMModel.ERROR),//08-0f
    PkgInt.pack4bits(SMModel.ERROR, SMModel.ERROR, SMModel.ERROR, SMModel.ERROR, SMModel.ITSME, SMModel.ITSME, SMModel.ITSME, SMModel.ITSME),//10-17
    PkgInt.pack4bits(SMModel.ITSME, SMModel.ITSME, SMModel.ITSME, SMModel.ITSME, SMModel.ITSME, SMModel.ITSME, SMModel.ERROR, SMModel.ERROR),//18-1f
    PkgInt.pack4bits(SMModel.ERROR, 5, SMModel.ERROR, SMModel.ERROR, SMModel.ERROR, 4, SMModel.ERROR, SMModel.ERROR),//20-27
    PkgInt.pack4bits(SMModel.ERROR, SMModel.ERROR, SMModel.ERROR, 6, SMModel.ITSME, SMModel.ERROR, SMModel.ITSME, SMModel.ERROR),//28-2f
    PkgInt.pack4bits(SMModel.ERROR, SMModel.ERROR, SMModel.ERROR, SMModel.ERROR, SMModel.ERROR, SMModel.ERROR, SMModel.ITSME, SMModel.ITSME),//30-37
    PkgInt.pack4bits(SMModel.ERROR, SMModel.ERROR, SMModel.ERROR, SMModel.ITSME, SMModel.ERROR, SMModel.ERROR, SMModel.ERROR, SMModel.ERROR),//38-3f
