 ...
 */
extern _Thread_local int program_birth_year;
 ...
 */
void report_and_exit(int ret);// av_noreturn; ==> longjmp; Now the function does not exit the program, but instead jumps back to the location of setjmp;

/**
 * Wraps exit with a program-specific cleanup routine.
 */
void exit_program(int ret);// av_noreturn; ==> longjmp; Now the function does not exit the program, but instead jumps back to the location of setjmp;
