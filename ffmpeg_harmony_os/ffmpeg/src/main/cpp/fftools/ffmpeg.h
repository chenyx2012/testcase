...
extern _Thread_local char *sdp_filename;

extern _Thread_local float audio_drift_threshold;
...
extern _Thread_local int qp_hist;
...
extern _Thread_local AVIOInterruptCB int_cb;

extern _Thread_local HWDevice *filter_hw_device;

extern _Thread_local unsigned nb_output_dumped;
extern _Thread_local int main_return_code;
...
#if FFMPEG_OPT_PSNR
extern _Thread_local int do_psnr;
#endif

extern _Thread_local int want_sdp;
